    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>NaviFuel</Text>
          <Text style={styles.subtitle}>
            Smart navigation with fuel cost calculation
          </Text>
        </View>
        ...
        <View style={styles.features}>
          ...
          <View style={styles.featuresList}>
            <Text style={styles.featureItem}>🗺️ Real-time navigation with Google Maps</Text>
            <Text style={styles.featureItem}>⛽ Smart fuel cost calculation</Text>
